...
void epdvar030bwry::epdEnterSleep() {
...
void epdvar030bwry::epdWriteDisplayData()
{
...
void epdvar030bwry::selectLUT(uint8_t lut) {
...
void epdvar030bwry::draw() {
    this->drawNoWait();
    this->epdWaitRdy();
    // epdBusyWaitRising(50000);
    // delay(100);
}
void epdvar030bwry::drawNoWait() {
