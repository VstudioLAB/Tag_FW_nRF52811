...
void showSplashScreen() {
    ...
    switch (tag.solumType) {
        ...
        case STYPE_SIZE_022_LITE:
            ...
            addQR(epd->Xres - 70, 8, 3, 2, "https://openepaperlink.eu/tag/0/%02X/%02X%02X%02X%02X%02X%02X%02X%02X/", tag.OEPLtype, mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
            break;		
		case STYPE_SIZE_022_BW:
            fr.setFont(&FreeSansBold18pt7b);
            fr.epdPrintf(2, 2, COLOR_BLACK, rotation::ROTATE_0, "OpenEPaperLink");
            fr.setFont(&FreeSans9pt7b);
            fr.epdPrintf(10, 38, COLOR_BLACK, rotation::ROTATE_0, "Newton M3 2.2\" BW");
            // fr.setFont(&FreeSans9pt7b);
            fr.epdPrintf(5, epd->Yres - 40, 0, rotation::ROTATE_0, "FW: %04X-%s", fwVersion, fwVersionSuffix);
            fr.epdPrintf(5, epd->Yres - 20, 0, rotation::ROTATE_0, "MAC: %02X:%02X:%02X:%02X:%02X:%02X:%02X:%02X", mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
            addQR(epd->Xres - 100, 2, 3, 3, "https://openepaperlink.eu/tag/0/%02X/%02X%02X%02X%02X%02X%02X%02X%02X/", tag.OEPLtype, mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
            break;
        case STYPE_SIZE_026:
            fr.setFont(&FreeSansBold18pt7b);
            fr.epdPrintf(2, 2, COLOR_BLACK, rotation::ROTATE_0, "OpenEPaperLink");
        ...
        case STYPE_SIZE_060:
            ...
            break;
        case STYPE_SIZE_060_BWRY:
            fr.setFont(&FreeSansBold24pt7b);
            fr.epdPrintf(10, 10, COLOR_BLACK, rotation::ROTATE_0, "OpenEPaperLink");
            fr.setFont(&FreeSansBold18pt7b);
            fr.epdPrintf(15, 60, 1, rotation::ROTATE_0, "Newton M3 6.0\" BWRY");
            fr.setFont(&FreeSans9pt7b);
            fr.epdPrintf(epd->Xres - 17, 310, 0, rotation::ROTATE_270, "FW: %04X-%s", fwVersion, fwVersionSuffix);
            fr.epdPrintf(10, epd->Yres - 25, 0, rotation::ROTATE_0, "MAC: %02X:%02X:%02X:%02X:%02X:%02X:%02X:%02X", mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
            addFlashImage(293, 61, COLOR_BLACK, rotation::ROTATE_0, newton);
        ...
        case STYPE_SIZE_027:
            ...
            fr.setFont(&FreeSansBold18pt7b);
            fr.epdPrintf(15, 40, COLOR_RED, rotation::ROTATE_0, "Newton M3 2.7\"");
            fr.setFont(&FreeSans9pt7b);
            fr.epdPrintf(epd->Xres - 20, 110, 0, rotation::ROTATE_270, "FW: %04X-%s", fwVersion, fwVersionSuffix);
            fr.epdPrintf(5, epd->Yres - 20, 0, rotation::ROTATE_0, "MAC: %02X:%02X:%02X:%02X:%02X:%02X:%02X:%02X", mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
...
void showAPFound() {
    ...
    switch (tag.solumType) {
        ...
        case STYPE_SIZE_022_LITE:
            ...
            addQR(epd->Xres - 100, 2, 3, 1, "https://openepaperlink.eu/tag/1/%02X/%02X%02X%02X%02X%02X%02X%02X%02X/", tag.OEPLtype, mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
            break;
		case STYPE_SIZE_022_BW:
            fr.setFont(&FreeSansBold18pt7b);
            fr.epdPrintf(7, 7, COLOR_BLACK, rotation::ROTATE_0, "AP Found");
        ...
        case STYPE_SIZE_027:
            ...
            uiPrintBatteryVoltage(&fr, 10, epd->Yres - 43);
            fr.epdPrintf(10, epd->Yres - 25, 0, rotation::ROTATE_0, "MAC: %02X:%02X:%02X:%02X:%02X:%02X:%02X:%02X", mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
            addQR(epd->Xres - 60, 100, 3, 2, "https://openepaperlink.eu/tag/1/%02X/%02X%02X%02X%02X%02X%02X%02X%02X/", tag.OEPLtype, mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
            break;
    }
    addOverlay();
    draw();
...
void showNoAP() {
    ...
    switch (tag.solumType) {
        ...
        case STYPE_SIZE_022_LITE:
            fr.setFont(&FreeSans9pt7b);
            fr.epdPrintf(7, 7, COLOR_BLACK, rotation::ROTATE_0, "No AP Found");
            addQR(epd->Xres - 120, 2, 3, 1, "https://openepaperlink.eu/tag/1/%02X/%02X%02X%02X%02X%02X%02X%02X%02X/", tag.OEPLtype, mSelfMac[7], mSelfMac[6], mSelfMac[5], mSelfMac[4], mSelfMac[3], mSelfMac[2], mSelfMac[1], mSelfMac[0]);
            fr.epdPrintf(10, 59, COLOR_BLACK, rotation::ROTATE_0, "Couldn't find an AP :(");
            fr.epdPrintf(10, 79, COLOR_BLACK, rotation::ROTATE_0, "I'll try again in a little while");
            break;
		case STYPE_SIZE_022_BW:
            fr.setFont(&FreeSansBold18pt7b);
            fr.epdPrintf(7, 7, COLOR_BLACK, rotation::ROTATE_0, "No AP Found");
